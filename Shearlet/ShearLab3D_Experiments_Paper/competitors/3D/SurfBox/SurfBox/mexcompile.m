...
if ispc
    ...
    FFTW_include = '/usr/include'; % where fftw3.h is installed
    
    % 2.2 Change the lib directory
    FFTW_lib = '/usr/lib64'; % where libfftw3.a is installed
    
    LIB_name = 'libfftw3.so';
end
...
SURFBOX_dir = '/homes/numerik/reisenho/Work/Shearlets/Shearlab3D/MyShearlab3D/Paper/competitors/3D/SurfBox/SurfBox';
