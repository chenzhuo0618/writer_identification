 ...
 * from the files:
 * <pre>
 *  /home/sn0w/scatterpca/test_writer.m
 *  /home/sn0w/scatterpca/train_writers.m
 * </pre>
...
public class MatlabJet extends MWComponentInstance<MatlabJet>
{
    ...
    {
        this(MatlabJetSharedMCRFactory.newInstance());
    }
    ...
    {
        this(MatlabJetSharedMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(MatlabJetSharedMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = MatlabJetSharedMCRFactory.newInstance();
