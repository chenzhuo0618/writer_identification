...
public class MatlabJet extends MWComponentInstance<MatlabJet>
{
    ...
    {
        this(MatlabJetWinMCRFactory.newInstance());
    }
    ...
    {
        this(MatlabJetWinMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(MatlabJetWinMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = MatlabJetWinMCRFactory.newInstance();
