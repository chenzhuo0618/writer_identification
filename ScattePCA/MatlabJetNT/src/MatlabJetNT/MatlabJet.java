...
public class MatlabJet extends MWComponentInstance<MatlabJet>
{
    ...
    {
        this(MatlabJetNTMCRFactory.newInstance());
    }
    ...
    {
        this(MatlabJetNTMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(MatlabJetNTMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = MatlabJetNTMCRFactory.newInstance();
