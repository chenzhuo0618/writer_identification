...
public class Class1 extends MWComponentInstance<Class1>
{
    ...
    {
        this(SonghuanMCRFactory.newInstance());
    }
    ...
    {
        this(SonghuanMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(SonghuanMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = SonghuanMCRFactory.newInstance();
