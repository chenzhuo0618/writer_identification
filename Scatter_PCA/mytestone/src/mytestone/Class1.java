...
public class Class1 extends MWComponentInstance<Class1>
{
    ...
    {
        this(MytestoneMCRFactory.newInstance());
    }
    ...
    {
        this(MytestoneMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(MytestoneMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = MytestoneMCRFactory.newInstance();
